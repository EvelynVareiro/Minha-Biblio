...
<head>
    ...
    <title>Conteúdo | Quero Ler</title>
</head>
<body>
    <style>
        ...
        <div class="container">
            <form action="" method="POST">
                <section class="parte_um">
                    ...
                    <div class="titulo">
                        <h1>Visualize o livro que você quer ler</h1>
                    </div>
                </section>
                ...
                <section class="parte_cinco">
                    <div class="btns">
                        <a href="editarQueroLer.php?id=<?php echo $livro['id']; ?>"><button class="editar-btn" id="editar" value="editar" type="button">EDITAR</button></a>
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Tem certeza que deseja excluir este livro?")) {
                window.location.href = "excluirLivro.php?id=" + id + "&table=queroler"; // Passa o ID e a tabela
            }
        }
    </script>
